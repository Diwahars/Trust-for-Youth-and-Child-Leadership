...
public class ChildrenRegistrationActivity extends AppCompatActivity {
    ...
    private EditText name, dob, sex, class_id , nameof_school_id  , address, mobileno;
    private String firstNameValue, lastNameValue , emailValue , passWordValue, mobileNumberValue;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.children_register_activity);
        initUiViews();
    ...
    private void initUiViews() {
        ...
        nameof_school_id  = (EditText) findViewById(R.id.nameof_school_id);
