 ...
 */
public class MendorMainActivity extends NavigationLiveo implements OnItemClickListener {
    private static final String LOG_TAG = MendorMainActivity.class.getSimpleName();
