 ...
 * Created by chokkar
 */
public class ProfileAlertAdapter extends BaseAdapter {
    String[] titleList;
    Integer[] imageList;
    Context context;
    private static LayoutInflater inflater = null;

    public ProfileAlertAdapter(Context mContext, String[] uploadAlertTitleList, Integer[] uploadAlertImagelist) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        ViewHolder holder;
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.profile_list_alert_dialog, null);
