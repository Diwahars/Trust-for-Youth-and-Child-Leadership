 ...
 * Created by chokkar
 */
public class MembersSetupFragment extends Fragment {
	...
	public static MembersSetupFragment newInstance(String text){
		MembersSetupFragment mFragment = new MembersSetupFragment();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.fragment_memberssetup, container, false);
		listview = (ListView) rootView.findViewById(R.id.listview_members);
