...
public class GroupSetupFragment extends Fragment {
	...
	private static final String LOG_TAG = GroupSetupFragment.class.getSimpleName();
	private String authKey;
	private SharedPreferences preferences;
	private ListView listview;

	public static GroupSetupFragment newInstance(String text){
		GroupSetupFragment mFragment = new GroupSetupFragment();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.fragment_group_setup, container, false);
